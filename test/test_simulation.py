...
class TestSeatAddedQuarterCar(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.seat_added_quarter_car = SeatAddedQuarterCarModel(self.car_parameters, self.initial_conditions)
    ...
    def test_seat_added_quarter_car_step_road(self):
        ...
        self.assertAlmostEqual(result.acc_mu_max, self.STEP_ROAD_EXPECTED['max_unsprung_acceleration'],places=2)
        self.assertAlmostEqual(result.acc_ms_max, self.STEP_ROAD_EXPECTED['max_sprung_acceleration'],places=2)
        self.assertAlmostEqual(result.vel_ms_max, self.STEP_ROAD_EXPECTED['max_sprung_velocity'],places=2)
        self.assertAlmostEqual(result.vel_mu_max, self.STEP_ROAD_EXPECTED['max_unsprung_velocity'],places=2)
        self.assertAlmostEqual(result.disp_ms_max, self.STEP_ROAD_EXPECTED['max_sprung_displacement'],places=2)
        self.assertAlmostEqual(result.disp_mu_max, self.STEP_ROAD_EXPECTED['max_unsprung_displacement'],places=2)
        self.assertAlmostEqual(result.disp_range_ms, self.STEP_ROAD_EXPECTED['displacement_range_ms'],places=2)
        self.assertAlmostEqual(result.disp_range_seat, self.STEP_ROAD_EXPECTED['displacement_range_seat'],places=2)
    ...
    def test_seat_added_quarter_car_sinusoidal_road(self):
        ...
        self.assertAlmostEqual(result.acc_mu_max, self.SINUSOIDAL_ROAD_EXPECTED['max_unsprung_acceleration'],places=2)
        self.assertAlmostEqual(result.acc_ms_max, self.SINUSOIDAL_ROAD_EXPECTED['max_sprung_acceleration'],places=2)
        self.assertAlmostEqual(result.vel_ms_max, self.SINUSOIDAL_ROAD_EXPECTED['max_sprung_velocity'],places=2)
        self.assertAlmostEqual(result.vel_mu_max, self.SINUSOIDAL_ROAD_EXPECTED['max_unsprung_velocity'],places=2)
        self.assertAlmostEqual(result.disp_ms_max, self.SINUSOIDAL_ROAD_EXPECTED['max_sprung_displacement'],places=2)
        self.assertAlmostEqual(result.disp_mu_max, self.SINUSOIDAL_ROAD_EXPECTED['max_unsprung_displacement'],places=2)
        self.assertAlmostEqual(result.disp_range_ms, self.SINUSOIDAL_ROAD_EXPECTED['displacement_range_ms'],places=2)
        self.assertAlmostEqual(result.disp_range_seat, self.SINUSOIDAL_ROAD_EXPECTED['displacement_range_seat'],places=2)
    ...
    def test_seat_added_quarter_car_chirp_road(self):
        ...
        self.assertAlmostEqual(result.acc_mu_max, self.CHIRP_ROAD_EXPECTED['max_unsprung_acceleration'],places=2)
        self.assertAlmostEqual(result.acc_ms_max, self.CHIRP_ROAD_EXPECTED['max_sprung_acceleration'],places=2)
        self.assertAlmostEqual(result.vel_ms_max, self.CHIRP_ROAD_EXPECTED['max_sprung_velocity'],places=2)
        self.assertAlmostEqual(result.vel_mu_max, self.CHIRP_ROAD_EXPECTED['max_unsprung_velocity'],places=2)
        self.assertAlmostEqual(result.disp_ms_max, self.CHIRP_ROAD_EXPECTED['max_sprung_displacement'],places=2)
        self.assertAlmostEqual(result.disp_mu_max, self.CHIRP_ROAD_EXPECTED['max_unsprung_displacement'],places=2)
        self.assertAlmostEqual(result.disp_range_ms, self.CHIRP_ROAD_EXPECTED['displacement_range_ms'],places=2)
        self.assertAlmostEqual(result.disp_range_seat, self.CHIRP_ROAD_EXPECTED['displacement_range_seat'],places=2)
