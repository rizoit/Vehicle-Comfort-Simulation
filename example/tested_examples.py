...
def seat_added_quarter_car():
    ...
    def first_run(sesion_name):
        ...
        # Vehicle parameters
        car_parameters = SeatAddedQuarterCarParams(ms=270,
                                                    mu=60,
                                                    m_seat=88,
                                                    ks=27000,
                                                    ku=200000,
        ...
        seat_added_quarter_car = SeatAddedQuarterCarModel(car_parameters, initial_conditions)
        ...
        sc_step = SimulationControl(seat_added_quarter_car, road_profile_step, (0,3), np.linspace(0,3,25000), name="Step Road")
        sc_sinusoidal = SimulationControl(seat_added_quarter_car, road_profile_sinusoidal, (0,3), np.linspace(0,3,25000), name="Sinusoidal Road")   
        sc_chirp = SimulationControl(seat_added_quarter_car, road_profile_chirp, (0,5), np.linspace(0,5,50000), name="Chirp Road")
...
def half_car():
    ...
    def first_run(sesion_name):
        ...
        # Vehicle parameters
        car_parameters = HalfCarModelParams(ms= 550,
                                            mu_f = 66,
                                            mu_r = 45,
                                            ku_f = 200000,
                                            ku_r = 200000,
        ...
        sc_step = SimulationControl(half_car, road_profile_step, (0,end_time), np.linspace(0,end_time,end_time*10000), name="Step Road")
        sc_sinusoidal = SimulationControl(half_car, road_profile_sinusoidal, (0,3), np.linspace(0,3,end_time*10000), name="Sinusoidal Road")   
        sc_chirp = SimulationControl(half_car, road_profile_chirp, (0,5), np.linspace(0,5,10000*20), name="Chirp Road")
